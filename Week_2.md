...
```
    ...
    2.46 ms ± 214 µs per loop (mean ± std. dev. of 7 runs, 100 loops each)
...
```
    ...
    274 µs ± 237 µs per loop (mean ± std. dev. of 7 runs, 100 loops each)
...
```
    ...
    1.64 s ± 17.8 ms per loop (mean ± std. dev. of 7 runs, 10 loops each)
...
```
    ...
    929 µs ± 1.4 ms per loop (mean ± std. dev. of 7 runs, 10 loops each)
